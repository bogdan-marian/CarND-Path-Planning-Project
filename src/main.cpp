      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Create a list of widely spaced (x,y) waypoints, eventualy spaced at 30m
            // Later wee will interpolate with a spline and fill with more points
            vector<double>ptsx;
            vector<double>ptsy;
            ...
            for (int i = 0; i< sensor_fusion.size();i++){
              ...
              // check the s in the future
              double check_car_s = check_car_s_now + 0.02 * prev_size * check_speed;
            ...
            // eithe will reference the starting point as where the car is or at the previous path end point
            double ref_x = car_x;
            double ref_y = car_y;
            double ref_yaw = deg2rad(car_yaw);

            // if pervious size is almost empty, use the car as starting reference
            if (prev_size < 2){
              ...
              //use yaw to calculate vehicle coordinate
            ...
            // Calculate how to brak up spline points so we travel at our desired velocity
            double target_x = 30;
